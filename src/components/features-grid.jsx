...
const FeaturesGrid = () => {
  ...
  const handleCardClick = (card, e) => {
    ...
    if (card.id === 1) {
      ...
      // The Fish Bowl - open external link
      window.open('https://drive.google.com/file/d/1e3VIqVGylZ9uFqixnaT1X81UvzDLHOsd/view?usp=sharing', '_blank', 'noopener,noreferrer');
    } else if (card.id === 4) {
